...
```{r, fig.width=12, fig.height=6}
bfi_pred <- predict(optimal_ranger_bfi, data = standard_p)$prediction
qm_pred <- predict(optimal_ranger_qm, data = standard_p)$prediction
q95_pred <- predict(optimal_ranger_q95, data = standard_p)$prediction
q5_pred <- predict(optimal_ranger_q5, data = standard_p)$prediction
rr_pred <- predict(optimal_ranger_rr, data = standard_p)$prediction
rbi_pred <- predict(optimal_ranger_rbi, data = standard_p)$prediction
