...
q_data  <-  read.csv("C:/Users/Logan/Desktop/College/Coursework/Junior Year/Research Project/data/CONUS_qdv.csv")
...
q_data$gauge_id <- ifelse(nchar(DailyQ$gauge_id) < 8, paste0("0", DailyQ$gauge_id), DailyQ$gauge_id)
...
#Join RBI data to camels_hydro data
camels_rbi <- left_join(camels_hydro, RBI, by = "gauge_id")
...
write_csv(RBI, "CAMELS Data/camels_rbi.csv")

#Write out joined file (camels_hydro + camels_rbi)
write_csv(camels_rbi, "CAMELS Data/camels_hydro_rbi.csv")
