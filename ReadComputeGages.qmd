...
USgages_BFI <- 
  ...
  tm_dots(col = "baseflow_index", palette = "viridis", size = 0.15, title = "Baseflow Index") + # controls symbology: what field, color, size
  ...
  tm_layout(legend.title.size = 1,
            ...
            legend.bg.alpha = 1, 
            main.title = "Baseflow Index",
            main.title.position = c("center","top")) # positioning
...
USgages_Q5 <- 
  tm_shape(camels_joined)+
  tm_dots(col = "q5", palette = "viridis", size = 0.15, title = "") + 
  tm_shape(states)+ # add states in background
  tm_borders() +
  tm_layout(legend.title.size = 1,
            legend.text.size = 0.6,
            ...
            #legend.bg.color = "white",
            legend.bg.alpha = 1,
            main.title = "Low Flow (Q5)",
            main.title.position = c("center","top")) # positioning

USgages_Q95 <- 
  tm_shape(camels_joined)+
  tm_dots(col = "q95", palette = "viridis", size = 0.15, title = "") + 
  tm_shape(states)+ # add states in background
  tm_borders() +
  tm_layout(legend.title.size = 1,
            legend.text.size = 0.6,
            ...
            #legend.bg.color = "white",
            legend.bg.alpha = 1,
            main.title = "High Flow (Q95)",
            main.title.position = c("left","top"))

USgages_Qmean <- 
  tm_shape(camels_joined)+
  tm_dots(col = "q_mean", palette = "viridis", size = 0.15, title = "") + 
  tm_shape(states)+ # add states in background
  tm_borders() +
  tm_layout(legend.title.size = 1,
            legend.text.size = 0.6,
...
USgages_runoffratio <- 
  tm_shape(camels_joined)+
  tm_dots(col = "runoff_ratio", palette = "viridis", size = 0.15, title = "") + 
  tm_shape(states)+ # add states in background
  tm_borders() +
  tm_layout(legend.title.size = 1,
            legend.text.size = 0.6,
            ...
            #legend.bg.color = "white",
            legend.bg.alpha = 1,
            main.title = "Runoff Ratio",
            main.title.position = c("left","top"))

USgages_RBI <- 
  tm_shape(camels_joined)+
  tm_dots(col = "RBI", palette = "viridis", size = 0.15, title = "") + 
  tm_shape(states)+ # add states in background
  tm_borders() +
  tm_layout(legend.title.size = 1,
            legend.text.size = 0.6,
            ...
            #legend.bg.color = "white",
            legend.bg.alpha = 1,
            main.title = "Richards-Baker Flashiness Index",
            main.title.position = c("left","top"))
