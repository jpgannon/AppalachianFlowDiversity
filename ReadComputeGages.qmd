...
var(camels_joined$q_mean, na.rm=TRUE)
var(app_gauges$q_mean, na.rm=TRUE)

var(camels_joined$q5,na.rm=TRUE)
var(app_gauges$q5, na.rm=TRUE)

var(camels_joined$q95,na.rm=TRUE)
var(app_gauges$q95, na.rm=TRUE)

var(camels_joined$runoff_ratio,na.rm=TRUE)
var(app_gauges$runoff_ratio, na.rm=TRUE)

var(camels_joined$baseflow_index,na.rm=TRUE)
var(app_gauges$baseflow_index, na.rm=TRUE)

var(camels_joined$RBI,na.rm=TRUE)
