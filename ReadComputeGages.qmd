...
#write.csv(camels_joined,"C:\\Users\\Logan\\Desktop\\College\\Coursework\\Junior Year\\Second Semester\\Analysis in GIS\\ESDA\\ESDA\\camels_joined.csv")
#st_write(camels_joined,"C:\\Users\\Logan\\Desktop\\College\\Coursework\\Junior Year\\Second Semester\\Analysis in GIS\\ESDA\\ESDA\\camels_joined.shp")
...
#Camels_all_joined |> 
  #ggplot(aes(AGGECOREGI,baseflow_index))+
  #geom_boxplot()
...
boxplot(app_gauges$baseflow_index~app_gauges$PROVINCE, main="Baseflow Index Across the Appalachian Mountains",xlab="Province",ylab="BFI",col=c("red2","blue","green"))
